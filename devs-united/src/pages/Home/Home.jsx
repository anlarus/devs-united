    ...
    <main>
      <div  className="font-face-silk">
        ...
        <GoogleLogin
          ...
          render={renderProps => (
            <div className="button-cover"><img class="google-icon-svg" src="https://upload.wikimedia.org/wikipedia/commons/5/53/Google_%22G%22_Logo.svg"/><button className="google-button" onClick={renderProps.onClick} disabled={renderProps.disabled}>Sign in with Google</button></div>
          )}
